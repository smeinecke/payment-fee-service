...
from payment_fee_service.bootstrap import build_registry
...
def main() -> None:
    ...
    registry = build_registry(Settings(fail_startup_on_data_error=True))
    print(json.dumps([info.model_dump() for info in registry.infos()], indent=2))
